...
#figure(
  ...
  caption: [审计日志分页与CSV导出],
)
#figure(
  grid(columns: 2, gutter: 1em,
    image("image/日志页正常分页.png", width: 100%),
    image("image/导出CSV下载.png", width: 100%),
  ),
...
#figure(
  ...
  caption: [健康检查：MySQL不可用与TRADE不可达],
)
#figure(
  grid(columns: 2, gutter: 1em,
    image("image/MySQL 不可用时健康检查（HC-002）.png", width: 100%),
    image("image/TRADE 不可达.png", width: 100%),
  ),
...
#figure(
  image("image/HTML注入.png", width: 60%),
  caption: [边界值测试——HTML标签输入被转义，未执行脚本],
)
