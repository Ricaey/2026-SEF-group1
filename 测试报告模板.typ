...
#table(
  ...
  [*编号*], [*实际输出*], [*是否通过*], [*备注*],
  [AUTH-001], [四种角色正常登录 | 200 | 200, 返回 JWT + role], [通过], [],
  ...
  [AUTH-005], [锁定到期自动解锁 | 200 | 200, 自动解锁成功], [通过], [改数据库 lock_until 后验证],
  [AUTH-006], [禁用账户无法登录 | 403 | 403, success=false], [通过], [],
  [AUTH-007], [正常登出 | 200 | 200, success=true], [通过], [],
  [AUTH-008], [无 Token 访问 | 401 | 401], [通过], [],
  [AUTH-009], [伪造 Token | 401 | 401], [通过], [],
  [AUTH-010], [Token 版本失效 | 401 | 401, 改密后旧 token 失效], [通过], [],
  [AUTH-011], [正确修改密码 | 200 | 200, success=true], [通过], [改密后自动恢复],
  ...
  [AUTH-016], [获取当前用户信息 | 200 | 200, username/role/status], [通过], [],
...
#table(
  ...
  [STOCK-011], [高级管理员添加新股票 | 200 | 200, 含涨跌停价], [通过], [],
...
#table(
  columns: (1.5fr, 5fr, 1fr, 5fr),
  [*编号*], [*实际输出*], [*是否通过*], [*备注*],
  [LIMIT-001], [高级管理员正常设置 | 200 | 200, TRADE返回涨跌停价], [通过], [],
  ...
  [LIMIT-009], [指定生效日期 | 200 | 响应含生效日期], [通过], [],
...
#table(
  ...
  [*编号*], [*实际输出*], [*是否通过*], [*备注*],
  [CTRL-001], [高级管理员暂停 | 200 | 200], [通过], [],
  [CTRL-002], [高级管理员重启 | 200 | 200], [通过], [],
...
#table(
  ...
  [*编号*], [*实际输出*], [*是否通过*], [*备注*],
  [TD-001], [开启交易日 | 200 | 200], [通过], [],
  [TD-002], [结束交易日 | 200 | 200], [通过], [],
...
#table(
  ...
  [*编号*], [*实际输出*], [*是否通过*], [*备注*],
  [PWD-001], [密码修改汇总验证 | 200 | 200], [通过], [等价于 AUTH-011],
...
#table(
  columns: (1.6fr, 5fr, 1fr, 5fr),
  [*编号*], [*实际输出*], [*是否通过*], [*备注*],
  [PERM-001], [系统管理员查看所有管理员 | 200 | 200, items ≥ 4], [通过], [],
  [PERM-002], [非系统管理员无权查看 | 403 | 403], [通过], [normal/senior/audit 均拒],
  [PERM-003], [修改管理员角色 | 200 | 200, success=true], [通过], [],
  [PERM-004], [禁用管理员(token_version+1) | 200 | 200, 禁用后旧 token 返回 403], [通过], [],
  [PERM-005], [修改股票授权范围 | 200 | 200, success=true], [通过], [],
  [PERM-006], [目标管理员不存在 | 404 | 404, success=false], [通过], [],
  ...
  [PERM-011], [系统管理员创建新管理员 | 200 | 200, data含admin_id等], [通过], [],
...
#table(
  ...
  [*编号*], [*实际输出*], [*是否通过*], [*备注*],
  [AUDIT-001], [审计管理员查询操作日志 | 200 | 200, 分页列表], [通过], [],
  [AUDIT-002], [系统管理员也可查询 | 200 | 200, success=true], [通过], [],
  [AUDIT-003], [普通/高级管理员无权 | 403 | 403], [通过], [],
  [AUDIT-004], [按管理员 ID 筛选 | 200 | 200, 筛选正确], [通过], [],
  [AUDIT-005], [按操作类型筛选 | 200 | 200, 筛选正确], [通过], [],
  [AUDIT-006], [按时间范围筛选 | 200 | 200, success=true], [通过], [],
  [AUDIT-007], [正常分页 | 200 | 200, page=1, page_size=10], [通过], [],
  [AUDIT-008], [分页边界(page_size上限) | 200 | 200], [通过], [],
  [AUDIT-009], [查询登录日志 | 200 | 200, 字段完整], [通过], [],
  [AUDIT-010], [导出操作日志 CSV | 200 | 200, content-type: text/csv], [通过], [],
  [AUDIT-011], [导出登录日志 CSV | 200 | 200, text/csv], [通过], [],
  [AUDIT-012], [导出时应用筛选条件 | 200 | 200], [通过], [],
  [AUDIT-013], [删除操作日志 | 200 | 200, "已删除 N 条日志"], [通过], [],
  [AUDIT-014], [按日期删除指定范围 | 200 | 200], [通过], [],
  [AUDIT-015], [日期格式无效 | 400 | 400, success=false], [通过], [],
  [AUDIT-016], [log_type 参数无效 | 422 | 422], [通过], [],
)
...
#figure(
  grid(
    columns: 2,
    gutter: 1em,
    image("image/日志页正常分页.png", width: 100%), image("image/导出CSV下载.png", width: 100%),
  ),
  caption: [审计日志——分页功能(左) / CSV导出(右)],
)
...
#table(
  ...
  [FE-012], [审计日志分页], [通过], [截图: 日志页正常分页],
  [FE-013], [CSV导出下载], [通过], [截图: 导出CSV下载],
